          ...
          // j[1] is the data JSON object
        	...
        	// Main car's localization Data
						...
						for (int i = 0; i < sensor_fusion.size(); i++)
						{
							...
							if(d < (2+4*lane + 2) && d > (2 +4*lane - 2))
							{
							  ...
							  // if using previous points can project s value out 
								...
								{
									// dont crash into the car in front 									
									too_close = true;									
								}
							...
							else
							{
								...
								if ( car_lane - lane == -1 )
								{             
                  is_car_on_left |= car_s - 30 < check_car_s && car_s + 30 > check_car_s;
                }
								else if ( car_lane - lane == 1 )
								{							
									is_car_on_right |= car_s - 30 < check_car_s && car_s + 30 > check_car_s;
                }
						...
						{
							ref_vel -= 0.224;
							if(!is_car_on_left && lane > 0)
								lane -= 1;
							else if (!is_car_on_right && lane < 2)
								lane += 1;
						}
          	...
          	json msgJson;
						...
						// if previous size is close to empty, use the car as starting reference
						if (prev_size < 2)
						{

							//These tow points make the path tangent to the car
						...
						// Calculate how to break up the spline points so that we travel at desired reference velocity
